...
<html>
    ...
    <body style="margin-left: 10px; background-color: beige">
        ...
        <div class="row g-3 mt-2" style="margin-left: 100px;">
            <div class="col-lg-10">
                <h1 class="mt-2">Create Form</h1>
            </div>
            <div class="col-lg-1" style="margin-left: 70px">
                <form action="DispatchServlet" method="POST">
                    <input type="hidden" value="${param.searchName}" name="searchName">
                    <input type="hidden" value="${param.searchId}" name="searchId">
                    <button type="submit" class="btn btn-primary" name="btAction" value="Search" title="Back"><i class="fas fa-home"></i></button>
                </form>
            </div>
        </div>
        ...
        <div class="container" style="background: rgb(128,128,128, 0.4); padding: 20px; border-radius: 25px">
            <form class="row g-3" action="StoreServlet" method="POST" enctype="multipart/form-data">
                <div class="col-md-7 row">
                    <div class="col-md-12 p-2">
                        <label for="productName" class="form-label">Product Name</label>
                        <input style="background-color: beige" type="text" class="form-control" id="productName" name="productName" value="${param.productName}">
                    ...
                    <div class="col-md-6 p-2">
                        ...
                        <input style="background-color: beige" type="text" class="form-control" id="mobileName" name="price" value="${param.price}">
                        <small class="text-danger">
                    ...
                    <div class="col-md-6 p-2">
                        ...
                        <input style="background-color: beige" type="text" class="form-control" id="mobileName" name="quantity" value="${param.quantity}">
                        <small class="text-danger">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea style="background-color: beige; resize: none" rows="5" class="form-control" id="desc" placeholder="Product's description" name="description">${param.description}</textarea>
                                <small class="text-danger">
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary mt-3" value="Store"><i class="fas fa-save"> STORE</i></button>
                ...
                <div class="col-md-5" style="text-align: center">
                    <img id="blah" src="#" alt="your image" style="height: 380px; width: 450px; border: 3px black"/>
                </div>
                <script>
